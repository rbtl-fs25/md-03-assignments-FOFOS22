...
```{r}
penguins_no_Chinstraps <- penguins |> 
...
```{r}
penguins_gentoo_bd_155 <- penguins |> 
...
```{r}
penguins_female_billLength_35 <- penguins |> 
...
```{r}
penguins_female_DreamTorgersen <- penguins |> 
  filter(sex == "female" & 
           species == "Chinstrap" &
...
```{r}
penguins_gentoo_or_bodymass <- penguins |> 
